/*
* BENTAR MASI BANYAK BUG DOAIN BIAR CEPAT SELESAI YE :V
* OH YA TTQ BUAT NazwaS
...
const { spammermenu } require('./database/menu/spammermenu')*/
/******END OF MENU INPUT******/
...
prefix = '.' // serah mau ganti apa
blocked = [] // jan di apus :v
...
async function starts() {
	...
	fs.existsSync('./sessions.json') && client.loadAuthInfo('./sessions.json')
	...
	await client.connect({timeoutMs: 30*1000})
        fs.writeFileSync('./sessions.json', JSON.stringify(client.base64EncodedAuthInfo(), null, '\t'))
	...
	client.on('chat-update', async (mek) => {
		try {
	        ...
	        /*pushname2 = client.icontacts[nameReq] != undefined ? client.icontacts[nameReq].vname || client.icontacts[nameReq].notify : undefined*/
				...
				case 'menu':
					...
					break
                                case 'makermenu':
                                        ...
                                        break
case '18+menu':
					client.sendMessage(from, 18+menu(prefix), text,  {quoted: mek})
					break
case 'downloadermenu':
					client.sendMessage(from, downloadermenu(prefix), text,  {quoted: mek})
					break
case 'educationmenu':
					client.sendMessage(from, educationmenu(prefix), text,  {quoted: mek})
					break
case 'funmenu':
...
case 'informationmenu':
					client.sendMessage(from, informationmenu(prefix), text,  {quoted: mek})
					break
case 'islammenu':
					client.sendMessage(from, islammenu(prefix), text,  {quoted: mek})
					break
case 'kerangmenu':
...
case 'mememenu':
                                        ...
                                        client.sendMessage(from, mememenu(prefix), text, {quoted: mek})
                                        break
case 'musicmenu':
					client.sendMessage(from, musicmenu(prefix), text,  {quoted: mek})
					break
...
case 'stalkmenu':
                                        ...
                                        client.sendMessage(from, stalkmenu(prefix), text, {quoted: mek})
                                        break

case 'wibumenu':
					client.sendMessage(from, wibumenu(prefix), text,  {quoted: mek})
					break
...
dmenu = `
 ...
 asu = `   *SPAMMERMENU* 
    ...
     ${prefix}spamgmail
    `
					client.sendMessage(from, asu, text,  {quoted: mek})
					case 'othermenu':
					Y = `  *OTHERMENU* 
   ${prefix}send
   ${prefix}wame
  ...
   ${prefix}fml2
  `
					client.sendMessage(from, Y, text,  {quoted: mek})
					break
                case 'bahasa':
               ...
               break
				...
				case 'snowwrite':
					...
					if (args.length < 1) return reply(`Kirim perintah ${prefix}snowwrite teks1|teks2, contoh ${prefix}snowwrite aqulzz|galuh`)
                                        if (!isUser) return reply(mess.only.daftarB)
					reply(mess.wait)
					anu = await fetchJson(`https://api.zeks.xyz/api/snowwrite?text1=${gbl7}&text2=${gbl8}&apikey=${zeks}`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek})
					break
				case 'marvellogo':
					...
					if (args.length < 1) return reply(`Kirim perintah ${prefix}marvellogo teks1|teks2, contoh ${prefix}marvellogo aqulzz|galuh`)
                                        if (!isUser) return reply(mess.only.daftarB)
					reply(mess.wait)
					anu = await fetchJson(`https://api.zeks.xyz/api/marvellogo?text1=${gbl5}&text2=${gbl6}&apikey=${zeks}`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek})
					break
		...
		case 'spamcall':
               client.updatePresence(from, Presence.composing)
				...
				case 'mp3':
					...
					m = body.slice(7)
					asu = await fetchJson(`http://lolhuman.herokuapp.com/api/ytaudio?apikey= ${LolKey}&url=${m}`)
...
 *link :* ${anu.result.url}  
 `
				...
				case 'tulis':
					...
					teks = body.slice(7)
					reply(mess.wait)
					anu = await fetchJson(`https://tobz-api.herokuapp.com/api/nulis?text=halo&apikey=${TobzKey}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				case 'info':
					...
					teks = `*Nama bot* : ${me.name}\n*Nomor Bot* : @${me.jid.split('@')[0]}\n*Prefix* : ${prefix}\n*Total Block Contact* : ${blocked.length}\n*The bot is active on* : ${kyun(uptime)}\n*Total Chat* : ${totalchat.length}\n\n *JIKA ADA BUG SILAHKAN HUBUNGI OWNER`
				...
				case 'alay':
                    ...
                    teks1 = gh.split("|")[0];
                    teks2 = gh.split("|")[1];
                    data = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=glitch&text1=${teks1}&text2=${teks2}&apikey=${TobzKey}`, {method: 'get'})
                    hasil = await getBuffer(data.result)
                    client.sendMessage(from, hasil, image, {quoted: mek, caption: 'neh...'})
                    break
                     case 'leave':
...
case 'antilinkgrup':
                ...
                if (isBadWord) return reply('anti badword sudah on')
                    ...
                    break
                    case 'do':
                    if (!isOwner) return reply('sapa kau')
					client.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
					break
                    case 'addbadword':
                    if (!isOwnerB) return reply('sapa kau ajg')
	    ...
	    case 'kapankah':
			...
			case 'closegc':
                ...
                case 'ninjalogo':
                      ...
                      gl2 = gh.split("|")[1];
                      reply(mess.wait)
                      anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=ninjalogo&text1=${gl1}&text2=${gl2}&apikey=${TobzKey}`, {method: 'get'})
                      buff = await getBuffer(anu.result)
                      client.sendMessage(from, buff, image, {quoted: mek})
                      break
                         case 'play2':
...
case 'play':   
				...
				anu = await fetchJson(`https://api-rull.herokuapp.com/api/yt/playmp3?q=${play}`)
				asu = await fetchJson(`https://api.zeks.xyz/api/ytplaymp3?q=,${play}&apikey=apivinz`)
				if (anu.error) return reply(anu.error)
				infomp3 = `*Lagu Ditemukan!!!*\nJudul : ${anu.result.title}\nId : ${anu.result.videoId}\nUkuran : ${anu.result.filesizeF}\nLink : ${anu.result.dl_link}\nDec :${anu.result.description}\n\n*TUNGGU SEBENTAR LAGI DIKIRIM MOHON JANGAN SPAM YA SAYANG*`
				buffer = await getBuffer(anu.result.thumbnail)
				client.sendMessage(from, buffer, image, {quoted: mek, caption: infomp3})
				lagu = await getBuffer(asu.result.url_audio)
				...
				case 'firetext':
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.zeks.xyz/api/tlight?text=${tels}&apikey=${zeks}`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
                                case 'gantengcek':
				...
				if (isUser) return reply(mess.only.daftarB)
					...
					break
                                case 'shota':
				    try{
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/randomshota?apikey=${TobzKey}`, {method: 'get'})
						buffer = await getBuffer(res.result)
                                                if (!isUser) return reply(mess.only.daftarB)
				...
				case 'logowolf':
					...
					reply(mess.wait)
					anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=wolflogo1&text1=${teks1}&text2=${teks2}&apikey=${TobzKey}`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek})
					break				
                                 case 'nsfw':
				...
				case 'randomanime':
					...
					reply(mess.wait)
                                        if (!isUser) return reply(mess.only.daftarB)
					anu = await fetchJson(`https://tobz-api.herokuapp.com/api/husbu?apikey=${TobzKey}`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek})
					break
				case 'husbu2':
				...
				case 'logowolf2':
					...
					if (args.length < 1) return reply(`teksnya mana? contoh ${prefix}logowolf Nazwa|Canss`)
                                        if (!isUser) return reply(mess.only.daftarB)
					reply(mess.wait)
					anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=wolflogo2&text1=${teks1}&text2=${teks2}&apikey=${TobzKey}`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek})
					break	
                                case 'delete':
            ...
            break
                                ...
                                case 'nsfwtrap':
                                        try{
                                                if (!isNsfw) return reply('❌ *NSFW MATI* ❌')
                                                if (!isUser) return reply(mess.only.daftarB)
                                                res = await fetchJson(`https://tobz-api.herokuapp.com/nsfwtrap?apikey=${TobzKey}`, {method: 'get'})
                                                buffer = await getBuffer(res.result)
                                ...
                                case 'neonlogo':
                                        ...
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=neon_light&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                ...
                                case 'neonlogo2':
                                        ...
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=neon_technology&text=${text1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih kak logonya...'})
                                        break
                                case 'lionlogo':
                                        ...
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=lionlogo&text1=${text1}&text2=${teks2}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih kak logonya...'})
                                        break
                                /*case 'jsholat':
                                        ...
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/jadwalshalat?q=${tels}&apikey=${TobzKey}`, {method: 'get'})
                                        reply(anu.result)
                                        break*/
                                case 'jokerlogo':
                                        var gh = body.slice(10)
                                        ...
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=jokerlogo&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih kak logonya...'})
                                        break
                                case 'jadwaltvnow':  
			       ...
			       reply(anu.result.jadwalTV)
					break
                                ...
                                case 'shadow':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=shadow&text=${text1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                ...
                                case 'burnpaper':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=burn_paper&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih kak gambarnya...'})
                                        break
                                case 'coffee':
...
case 'coffee2':
                                ...
                                case 'lovepaper':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=love_paper&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih gambarnya kak...'})
                                        break
                                case 'woodblock':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=wood_block&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih gambarnya kak...'})
                                        break
                                case 'qowheart':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=quote_on_wood_heart&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih gambarnya kak...'})
                                        break
                                case 'mutgrass':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=message_under_the_grass&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih gambarnya kak...'})
                                        break
                                case 'undergocean':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=underwater_ocean&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih gambarnya kak...'})
                                        break
                                case 'woodenboards':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=wooden_boards&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih gambarnya kak...'})
                                        break
                                case 'wolfmetal':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=wolf_metal&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih gambarnya kak...'})
                                        break
                                case 'metalictglow':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=metalic_text_glow&text=${teks1}&apikey=${TobzKey}`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih gambarnya kak...'})
                                        break
                                case '8bit':
                                ...
                                case 'fml2':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        data = await fetchJson(`https://tobz-api.herokuapp.com/randomfmylife?apikey=${TobzKey}`, {method: 'get'})
                                        hasil = `*Fuck My Life*\n${data.result}`
                                        reply(hasil)
                                        break
                                case 'tiktok':
...
case 'addsticker':
				...
				client.sendMessage(from, `Berhasil menyimpan sticker!`, text, { quoted: mek })
				break
case 'addimage': 
				if (!isOwner) return reply(mess.only.ownerB)
					...
					fs.writeFileSync(`./database/audio/${svst}.jpeg`, delb)
					
					client.sendMessage(from, `Sukses Menambahkan Video\nCek dengan cara ${prefix}listimage`, text, { quoted: mek })
					break
				case 'addaudio':
                   if (!isOwner) return reply(mess.only.ownerB)
                   ...
                   fs.writeFileSync(`./database/audio/${gsh}.mp3`, gx)
...
case 'getaudio': 
					...
					client.sendMessage(from, buffer, audio, { quoted: mek, caption: `Result From Database : ${namastc}.jpeg` })
					break
case 'addvn':
                   if (!isOwner) return reply(mess.only.ownerB)
                   if (!isQuotedAudio) return reply('Reply audio nya om')
                   ...
                   uyw = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
                   gx = await client.downloadMediaMessage(uyw)
                   fs.writeFileSync(`./database/audio/${gsh}.ptt`, gx)
                    reply('Berhasil menyimpan audio!')
                     break
case 'getvn': 
				
					namastc = body.slice(10)
					buffer = fs.readFileSync(`./database/audio/${namastc}.ptt`)
...
case 'getimage': 
				...
				case 'addvideo': 
					...
					fs.writeFileSync(`./datbase/video/${svst}.mp4`, delb)
					
					client.sendMessage(from, `Sukses Menambahkan Video\nCek dengan cara ${prefix}listvideo`, text, { quoted: mek })
					break
				case 'getvideo': 
...
case 'googletext':
			...
			ct = body.slice(6)
				...
				asu = await getBuffer(`http://lolhuman.herokuapp.com/api/gsuggest?apikey= ${LolKey}&text1=${ll1}&text2=${ll2}&text3=${ll3}`)
